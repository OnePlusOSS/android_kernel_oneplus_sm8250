...
static int rk826_driver_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	}else if (chip->warp_fw_type == WARP_FW_TYPE_RK826_4450_WARP_FFC_5V6A_4BIT_65W) {
		chip->firmware_data = Rk826_fw_data_4450_swarp_6500MA_fef9;
        chip->fw_data_count = sizeof(Rk826_fw_data_4450_swarp_6500MA_fef9);
        chip->fw_data_version = Rk826_fw_data_4450_swarp_6500MA_fef9[chip->fw_data_count - 4];
	}
